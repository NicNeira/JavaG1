...
public class EjercicioCasoCasino {
	...
	public static void main(String[] args) {
		...
		/*
		 * Solicitar todos los string nombre, apellido, direccion Solicitar todo lo
		 * numerico edad, numeroDireccion Usuario Ingrese saldo($)
		 * 
		 * Validar que usuario sea mayor de edad, minimo en bolsillo $50000 minimo de
		 * apuesta $10000 (Si no tiene ese dinero no puede apostar)
		 * 
		...
		int max = 3; //numero max del azar

		// Variables String solicitadda
		String nombre;
		String apellido;
		String direccion;

		// Variables tipo int solicitadas
		int edad;
		int numeroDireccion;
		int saldo;
		...
		// Se solicitan al usuario los datos de tipo numerico
		System.out.println("Ingrese su edad");
		edad = sc.nextInt();
		System.out.println("Ingrese los digitos de su direccion");
		numeroDireccion = sc.nextInt();

		// Se solicita al usuario que ingrese el saldo
		System.out.println("Ingrese su saldo");
		saldo = sc.nextInt();

		// condiciono si se cumple la mayoria de edad, ejemplo 17< 18 hace esto de abajo
		if (edad < mayoriaEdad) {

			System.out.println("No puedes ingresar ya que eres menor de edad");

			//si cumple con la edad y el saldo es mayor que el minimo para ingresar, realizamos esto
		} if (saldo>=50000) {
			...
			//Aun no comprendo muy bien lo del while pero mientras salir sea distinto de false, se realizara esta accion
			while (!salir) {
				//Opciones del menu
				...
				switch (opcion) {//Es una opcion de multiples vias, segun el caso y la opcion que se marque es lo que se realiza
				...
				case 1:
					...
					//Funcion del numero al azar (max numero que arrojara - min numero que arrojara)
		            ...
		            if (numeroAzar==eleccion) {
		            	//sumar el saldo despues de la apuesta + la apuesta x 2 (la apuesta + lo ganado por la apuesta)
					...
					break;//Termina el switch y vuelve al inicio
